...
public class RegisterToGentille extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_to_gentille);
    ...
    private void insertdata(String username, String password)
    {
        ...
        Intent intent = new Intent(RegisterToGentille.this,MainActivity.class);
